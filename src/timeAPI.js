...
export async function initTimeAPI() {
  ...
  try {
    ...
    document.body.insertAdjacentHTML(
      'beforeend',
      `<pre style="position:fixed;left:0;top:0;z-index:99999;background:#000;color:#0f0;padding:8px;max-width:100vw;white-space:pre-wrap">${String(err.stack || err)}</pre>`
    );
    throw err;
  }
}
